        ...
        <div className={classes.titleWrapper}>
          ...
          >
            {variant?.color?.value && (
              <div
                style={{
                  width: '1rem', // w-8 -> 8 divided by 4 = 2rem
                  height: '1rem', // h-8 -> 8 divided by 4 = 2rem
              ...
              >
                <div
                  style={{
                    position: 'absolute',
                    width: '1.5rem', // w-10 -> 10 divided by 4 = 2.5rem
                    height: '1.5rem', // h-10 -> 10 divided by 4 = 2.5rem
                    borderRadius: '9999px', // rounded-full -> full border radius
